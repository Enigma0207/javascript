...
// 2, le nombre d'élément dans un tableau

/*Accéder(via son index) à un élément du tableau. l'index cest de o à plus l'infini 
et par defaux les language 0 en premier index si c'eta$st pas indiqué/*
var first = fruits[0];
// Apple
